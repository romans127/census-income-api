...
def run_sanity_check(test_dir):
    ...
    # assert path.isdir(test_dir), FAIL_COLOR+f"No direcotry named {test_dir} found"
    print(
    ...
    if not test_functions_for_post:
        ...
        print(
            FAIL_COLOR + "Please make sure you have TWO test cases for the POST() "
        ...
        if len(test_functions_for_post) >= 2 and COUNT_POST_METHOD_TEST_FOR_INFERENCE_RESULT < 2:
            ...
            WARNING_COUNT += 1
            print(
                FAIL_COLOR + "You do not seem to have TWO separate test cases, one "
    ...
    print(
        WARN_COLOR + "This is a heuristic based sanity testing and cannot "
        "guarantee the correctness of your code."
    )
    print(
        WARN_COLOR + "You should still check your work against the rubric to "
